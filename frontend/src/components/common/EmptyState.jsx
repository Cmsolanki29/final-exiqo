...
export const EmptyState = ({ icon, title, subtitle, action }) => (
  <div className="px-6 py-10 text-center text-gray-400">
    <div className="mb-4 flex justify-center text-gray-500" aria-hidden>
    ...
    {subtitle ? <div className="mx-auto mt-2 max-w-md text-sm leading-relaxed text-gray-400">{subtitle}</div> : null}
