...
const TransactionTable = forwardRef<HTMLElement, Props>(function TransactionTable({ rows }, ref) {
  const reduce = useReducedMotion();

  return (
    <motion.section
      ref={ref}
      className="mt-6 rounded-xl border border-white/[0.06] p-6"
    ...
    >
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[720px] border-collapse text-left text-sm">
          <thead>
            <tr className="border-b border-white/[0.06] text-[11px] font-semibold uppercase tracking-[0.12em]" style={{ color: "#8b8fa8" }}>
