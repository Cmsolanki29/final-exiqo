    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-8">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <MetricRow label="Accuracy"  value={fmtNumber(xgbMetrics.accuracy)}  />
            <MetricRow label="Precision" value={fmtNumber(xgbMetrics.precision)} />
            <MetricRow label="Recall"    value={fmtNumber(xgbMetrics.recall)}    />
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 text-sm">
          <InfoTile label="Branches" value={status?.branches ?? health?.branches ?? "—"} />
          <InfoTile label="Hidden dim" value={status?.hidden_dim ?? "—"} />
          <InfoTile label="Epochs trained" value={status?.epochs_trained ?? "—"} />
          <InfoTile label="Training positives" value={status?.training_positives ?? "—"} />
